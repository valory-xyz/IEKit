...
.PHONY: test
test:
	pytest -rfE packages/valory/skills/score_read_abci -rfE packages/valory/skills/score_write_abci -rfE packages/valory/skills/impact_evaluator_abci -rfE packages/valory/skills/dynamic_nft_abci --cov-report=html --cov=packages.valory.skills.score_read_abci --cov=packages.valory.skills.score_write_abci --cov=packages/valory/dynamic_nft_abci --cov=packages/valory/impact_evaluator_abci --cov-report=xml --cov-report=term --cov-report=term-missing --cov-config=.coveragerc
	find . -name ".coverage*" -not -name ".coveragerc" -exec rm -fr "{}" \;

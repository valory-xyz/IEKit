...
class MultiSendContract(Contract):
    ...
    @classmethod
    def get_tx_data(
        cls, ledger_api: LedgerApi, contract_address: str, multi_send_txs: List[Dict], **kwargs: Any
    ) -> Optional[JSONLike]:
        """
    ...
    @classmethod
    def get_tx_list(
        cls, ledger_api: LedgerApi, contract_address: str, multi_send_data: str, **kwargs: Any
    ) -> Optional[JSONLike]:
        """

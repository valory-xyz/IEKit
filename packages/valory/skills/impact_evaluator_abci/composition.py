...
abci_app_transition_mapping: AbciAppTransitionMapping = {
    ...
    TwitterScoringAbci.FinishedTwitterCollectionRound: MechResponseStates.MechResponseRound,
    MechFinalStates.FinishedMechResponseRound: MechRequestStates.MechRequestRound,

...
from packages.CI.skills.score_read_abci.behaviours import (
    ScoreReadBaseBehaviour,
    ScoreReadRoundBehaviour,
    ScoringBehaviour,
    TwitterObservationBehaviour,
)
from packages.CI.skills.score_read_abci.rounds import (
    DegenerateRound,
    Event,
...
class BaseScoreReadTest(FSMBehaviourBaseCase):
    """Base test case."""
...
class TestScoringBehaviour(BaseScoreReadTest):
    """Tests ScoringBehaviour"""

    # TODO: set next_behaviour_class
    behaviour_class: Type[BaseBehaviour] = ScoringBehaviour
...
class TestTwitterObservationBehaviour(BaseScoreReadTest):
    """Tests TwitterObservationBehaviour"""

    # TODO: set next_behaviour_class
    behaviour_class: Type[BaseBehaviour] = TwitterObservationBehaviour
    next_behaviour_class: Type[BaseBehaviour] = ...

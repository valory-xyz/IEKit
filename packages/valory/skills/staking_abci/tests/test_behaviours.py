...
"""This package contains round behaviours of StakingAbciApp."""
...
class BaseStakingTest(FSMBehaviourBaseCase):
    """Base test case."""

    path_to_skill = Path(__file__).parent.parent

    behaviour: StakingRoundBehaviour
    behaviour_class: Type[StakingBaseBehaviour]
    next_behaviour_class: Type[StakingBaseBehaviour]
...
class TestActivityScoreBehaviour(BaseStakingTest):
    """Tests ActivityScoreBehaviour"""

    # TODO: set next_behaviour_class
    behaviour_class: Type[BaseBehaviour] = ActivityScoreBehaviour
...
class TestActiviyUpdatePreparationBehaviour(BaseStakingTest):
    """Tests ActiviyUpdatePreparationBehaviour"""

    # TODO: set next_behaviour_class
    behaviour_class: Type[BaseBehaviour] = ActiviyUpdatePreparationBehaviour
    next_behaviour_class: Type[BaseBehaviour] = ...
...
class TestCheckpointPreparationBehaviour(BaseStakingTest):
    """Tests CheckpointPreparationBehaviour"""

    # TODO: set next_behaviour_class
    behaviour_class: Type[BaseBehaviour] = CheckpointPreparationBehaviour
    next_behaviour_class: Type[BaseBehaviour] = ...

...
"""This package contains the tests for rounds of Staking."""
...
class BaseStakingRoundTest(BaseRoundTestClass):
...
class TestActivityScoreRound(BaseStakingRoundTest):
    """Tests for ActivityScoreRound."""

    round_class = ActivityScoreRound
...
class TestActiviyUpdatePreparationRound(BaseStakingRoundTest):
    """Tests for ActiviyUpdatePreparationRound."""

    round_class = ActiviyUpdatePreparationRound
...
class TestCheckpointPreparationRound(BaseStakingRoundTest):
    """Tests for CheckpointPreparationRound."""

    round_class = CheckpointPreparationRound

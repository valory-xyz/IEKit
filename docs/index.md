...
1. [Set up your system](https://open-autonomy.docs.autonolas.tech/open-autonomy/guides/set_up/) to work with the Open Autonomy framework. We recommend that you use these commands:
    ...
    pipenv install open-autonomy[all]==0.18.4
...
2. Fetch the IEKit.
    ...
    ```bash
    autonomy fetch valory/impact_evaluator:0.1.0:bafybeifb3suo5w6xkzli4dquswxkzuiptrlcqqd74ks5eon35eckskb6wi --service
    ```

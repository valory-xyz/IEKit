...
1. [Set up your system](https://stack.olas.network/open-autonomy/guides/set_up/) to work with the Open Autonomy framework. We recommend that you use these commands:
    ...
    pipenv install open-autonomy[all]==0.21.18
...
2. Fetch the IEKit.
    ...
    ```bash
    autonomy fetch valory/impact_evaluator:0.1.0:bafybeigckk5tezej4lx5cz22d5wdhyggquwaf4ka6kenjo2mt5svc7xd5q --service
    ```
